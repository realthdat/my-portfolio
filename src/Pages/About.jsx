      ...
      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
          ...
          <img
            src="/Photo.jpg"
            alt="Profile"
            className="w-full h-65 object-cover transition-all duration-700 group-hover:scale-110 group-hover:rotate-2"
            loading="lazy"
          />
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I'm deeply passionate about Information Technology and constantly driven by curiosity to explore the new and exciting innovations humanity continues to create. I have a strong desire to learn, grow, and apply my knowledge to real-world problems. I’m always working on turning IT ideas into practical solutions that can bring value to society and make a meaningful difference.
            </p>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/drive/folders/1aN3HdXYuCjje3i2_kLMbbcHeOgZSN99p?usp=sharing" className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
