...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      /* Use formspree.io */
      const response = await fetch('https://formspree.io/f/manjdpba', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Have something you'd like to discuss? <br/> Feel free to send a message – I'm always open to a conversation.
        </p>
      </div>
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Got a question? Reach out and I'll get back to you as soon as possible.
                </p>
              </div>
